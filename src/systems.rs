...
//! operation: asymmetric cryptography, symmetric cryptography, key derivation functions,
...
//! - `symmetric`: Implementations of symmetric encryption schemes
